...
After bringing to a common denominator, this is $a/s$ with $a \in \textgoth{p}$, so $ \textgoth{p} A_\textgoth{p}$ is the single maximal ideal of the local ring $A_\textgoth{p}$ .
...
% \noindent
Definition of the $S^{-1}M$ as $S^{-1}A$-module in the text.
\[
...
After bringing to a common denominator, this becomes $ab/s$ where $a \in \textgoth{p}$. Notice we got a general element of $\textgoth{p} B_\textgoth{p}$, so
