...
\]
fails to be distributive over the addition.
\begin{equation*}
\begin{split}
\frac{b''}{s''} \left( \frac{b'}{s'} + \frac{b'}{s'} \right)
& = \frac{b''}{s''}\frac{sb' + s'b}{ss'} \\
& = \frac{b''(sb' + s'b)}{ss'} \\
& = \frac{sb''b' + s'b''b}{ss'} \\
& = \frac{sb''b'}{ss'} + \frac{s'b''b}{ss'}
\end{split}
\end{equation*}
\begin{equation*}
\begin{split}
\frac{b''}{s''} \frac{b'}{s'} + \frac{b''}{s''} \frac{b}{s}
& = \frac{b''b'}{s''s'} + \frac{s'b''b}{s''s} \\
& = \frac{s'sb''b' + s''s'b''b}{s''s's''s} \\
& = \frac{f(s')f(s)b''b' + f(s'')f(s')b''b}{s''s's''s} \\
& = \frac{f(s')f(s)b''b'}{s''s's''s} + \frac{f(s'')f(s')b''b}{s''s's''s}
\end{split}
\end{equation*}
and we cannot cancel here to make them equal.
\qed

\begin{theorem}
$B_\textgoth{p} \cong B_\textgoth{q}$ as $A_\textgoth{p}$-modules.    
\end{theorem}

\noindent
By Exercise 4: $T = f(S)$ then $S^{-1}B \cong T^{-1}B$ since $f(\textgoth{p}) = \textgoth{q}$.
\qed
